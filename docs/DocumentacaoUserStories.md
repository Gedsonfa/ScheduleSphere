...
| 29/12/2023 | 1.1     | Dando continuidade ao documento | IDavi , Felippe |
| 30/12/2023 | 1.2     | Dando continuidade ao documento| Gedson, Jose Gabriel |
...
| **Analista**| Felippe (responsável por especificar/detalhar). |
| **Desenvolvedor** | Jose Gabriel (responsáveis por implementar e realizar testes de unidade e testes de integração). |
| **Revisor** | Davi Natan (responsável por avaliar a implementação e executar os testes de unidade e testes de integração). |
| **Testador** | Gedson (responsável por executar os Testes de Aceitação e fazer o relatório de testes). |
...
| **Analista**| Felippe  (responsável por especificar/detalhar). |
| **Desenvolvedor** | Jose Gabriel (responsáveis por implementar e realizar testes de unidade e testes de integração). |
| **Revisor** | Davi (responsável por avaliar a implementação e executar os testes de unidade e testes de integração). |
| **Testador** | Gedson(responsável por executar os Testes de Aceitação e fazer o relatório de testes). |
...
| **TA02.04** | O funcionário/gerente tenta pesquisar um cliente e tem sucesso, a pesquisa é retornada. |
| **TA02.05** | O funcionário/gerente tenta pesquisar um cliente e não há retorno (exibição vazia). |
...
| **TA03.02**n | O cliente escolhe um horário livre e sua vaga e reservada com sucesso. |
...
| **Tempo Gasto (real):**   |                | 
| **Tamanho Funcional** | 8 PF (pontos de função) |
| **Analista**| Jose Gabriel (responsável por especificar/detalhar). |
| **Desenvolvedor** | Davi (responsáveis por implementar e realizar testes de unidade e testes de integração). |
| **Revisor** | Gedson (responsável por avaliar a implementação e executar os testes de unidade e testes de integração). |
| **Testador** | Felippe (responsável por executar os Testes de Aceitação e fazer o relatório de testes). |
